...
CLONE_DB_URI = environ.get("CLONE_DB_URI", "mongodb+srv://rani828719:sVyRWZOrUzIWNfHp@cluster0.zodktob.mongodb.net/?retryWrites=true&w=majority")
...
PICS = (environ.get('PICS', 'https://te.legra.ph/file/66604e5911df5a0c43ffa.jpg')).split() # Bot Start Picture
...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002022119783'))
    ...
    if HAS_SSL:
        URL = "https://sastamarvel-satass.onrender.com"
    else:
        URL = "https://sastamarvel-satass.onrender.com"
